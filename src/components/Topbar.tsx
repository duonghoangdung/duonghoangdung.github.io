...
const Topbar = ({ ...props }) => {
  ...
  return (
    <div
      className='flex items-center gap-6 bg-[#fcfcfc] px-6 md:px-10 py-0 md:py-6 w-full shadow-[inset_0_-1px_0_#f4f4f4]'
      {...props}
    >
        ...
        <div className='rounded-xl bg-[#ffd88d] text-[#1a1d1f] w-full max-w-full p-2'>
          <Marquee gradient={false} className='overflow-hidden'>
            <p className='text-sm font-semibold'>
              This aggregator is just a tool designed to make your trading easier, be aware that
              DEXTools does not endorse or verify any token listed here.
            </p>
          </Marquee>
        </div>
      </div>
