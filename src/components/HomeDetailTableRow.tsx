    ...
    <tr>
      ...
      <td className='border-b border-[#efefef] text-left p-5'>
        <div className='flex items-center'>
          <img
            src='//via.placeholder.com/44x44.png'
            className='w-[80px] h-[80px] md:w-[40px] md:h-[40px] rounded-full object-cover mr-5 md:mr-3'
          />
          <div className='grow'>
      ...
      <td className='border-b border-[#efefef] hidden md:table-cell p-5 text-right'>
        2022-06-29 09:29:55
      </td>
    </tr>
  )
